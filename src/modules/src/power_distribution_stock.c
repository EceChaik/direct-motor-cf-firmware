...
void powerDistribution(const control_t *control)
{
  ...
  if(control->ground_control){
    motorPower.m1 = limitThrust(control->motors.m1);
    motorPower.m2 = limitThrust(control->motors.m2);
    motorPower.m3 = limitThrust(control->motors.m3);
    motorPower.m4 = limitThrust(control->motors.m4);
  }else{
